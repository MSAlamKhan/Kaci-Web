...
export const users = [
  {
    ...
    moreDetails: {
      ...
      "Location History": {
        "1st location": { Date: "2020-05-12", Location: "Wuse, Abuja" },
        "2nd location": { Date: "2020-05-12", Location: "Wuse, Abuja" },
      },
      "Kaci Code": {
        amount: 46,
...
export const ambulanceRequests = [
  {
    "S/N": 0,
    KSN: 463500000000975,
    "Reference Code": 6765767,
    "Full Name": "Neil Nittin Mukesh",
    Device: "Android",
    "Date/Time": "5/18/2023, 1:00:05 PM",
    Country: "Nigeria",
    "Phone number": "+643540543434",
    Location: "Wuse, Abuja",
    Address: "street no.13, Wuse, Abuja",
    "Ambulance service": "(service name)",
    "People involved": 2,
    "Incidence Nature": "(incidence nature)",
    "Previous Hospital": "(hospital name)",
    "On Medication": "No",
    Admin: "(Admin)",
    Status: "Pending",
    media: [
...
export const iReports = [
  {
    ...
    Country: "Nigeria",
    "Phone number": "+643540543434",
    "Occurrence Location": "Wuse, Abuja",
    Address: "street no.13, Wuse, Abuja",
    "Occurrence Date/Time": "5/18/2023, 1:00:05 PM",
    "Target Agency": "(agency name)",
    "Report Subject": "dkasdhfktyfisd",
    "Report Details": "sdfa satfaisut uftas tfiaustf ytf.",
    Anonymous: "Yes",
    Admin: "(Admin)",
    Status: "Pending",
    media: [
...
export const infoBank = [
  {
    "S/N": 0,
    "Toll Free (One)": "Yes",
    "Special Call Centers (Two minimum)": 0,
    Country: "Nigeria",
  },
  {
    "S/N": 1,
...
export const suggestions = [
  {
    ...
    Address: "street no.13, Wuse, Abuja",
    "Target Agency": "(agency name)",
    "Problem Statement": "dkasdhfktyfisd",
    "Situation Suggestion": "sdfa satfaisut uftas tfiaustf ytf.",
    "Proposed Outcome": "sdifgyh iys tgsdu tisut ist.",
    Admin: "(Admin)",
    Status: "Pending",
    media: [
      "https://loremflickr.com/320/240",
...
export const feedbacks = [
  {
    ...
    Country: "Nigeria",
    "Phone number": "+643540543434",
    Feedback: "sdifgyh iys tgsdu tisut ist.",
    Admin: "(Admin)",
    Status: "Pending",
    media: [
      "https://loremflickr.com/320/240",
...
export const kaciCodes = [
  {
    "S/N": 0,
    Title: "kdfg ksfsfgisudfiuy",
    Amount: 25,
    "Expiry Date": "5/18/2023",
    Status: "Active",
  },
  {
    "S/N": 1,
