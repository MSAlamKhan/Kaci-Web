...
const UsersManagement = () => {
  ...
  const { searchInput, toggleCountry, toggleLocation, toggleStatus } = filters;
      ...
      setPaginatedData((prev) => ({
        ...
        items: data.filter(
          (user) =>
            ...
            user["Email Address"].toLowerCase().includes(value.toLowerCase())
        ),
      }));
    }
  };
  ...
  useEffect(() => {
    // fetch data
    setTimeout(() => {
      setPaginatedData({ items: users, curItems: [] });
      setData(users);
    }, 2000);
  }, []);
        ...
        <Paginatation {...{ itemsPerPage: 2, paginatedData, setPaginatedData }}>
          <AdvancedTable
            {...{
              ...
              setPaginatedData,
              Actions,
              actionCols: ["Details", "Delete", "Block"],
            }}
          >
              ...
              <div className="flex justify-between items-center w-full self-end lg:self-auto lg:w-auto mt-3 lg:mt-0">
                ...
                <div className="w-full flex justify-between xs:w-auto xs:justify-normal">
                  ...
                  <DropdownFilter
                    ...
                    setToggle={() =>
                      setSingleFilter("toggleLocation", !toggleLocation)
                    }
                    handleClick={(elem) =>
...
const Actions = ({
  ...
  const redirect = () => navigate("/users-management/user-details/" + id);
